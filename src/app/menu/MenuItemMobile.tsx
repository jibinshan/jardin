...
const MenuItemMobile: FC<MenuItemProps> = ({ id }) => {
  ...
  return (
    item && (
      ...
      <section className="z-10 flex h-fit w-full flex-row items-center overflow-hidden bg-menuforeground px-4 py-4">
        <div
          className={cn(
        ...
        >
          <div className="flex w-full flex-col gap-2">
            <MenuItemDrawer item={item} setChoose={setOpen}>
              <h2 className="w-full font-inter text-xl font-[600] capitalize leading-[150%] tracking-[1px] text-menuprimary">
                {item.name}
              </h2>
            </MenuItemDrawer>
            <MenuItemDrawer item={item} setChoose={setOpen}>
